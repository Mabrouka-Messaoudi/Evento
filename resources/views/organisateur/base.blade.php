...
<div class="sidebar">
    ...
    <div class="nav-item">
        <a href="{{ url('/organisateur/dashboard') }}">
            <i class="fas fa-calendar-alt"></i> <!-- Icon for Mes Événements -->
            Mes Événements
        </a>
    </div>
    <div class="nav-item">
        <a href="{{ url('/organisateur/events/creer') }}">
            <i class="fas fa-plus-circle"></i> <!-- Icon for Créer un Événement -->
            Créer un Événement
        </a>
    </div>
    <div class="nav-item">
        <a href="{{ url('/organisateur/reservations') }}">
            <i class="fas fa-ticket-alt"></i> <!-- Icon for Réservations -->
            Réservations
        </a>
    </div>
</div>
