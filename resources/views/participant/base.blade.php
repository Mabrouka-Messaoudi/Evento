...
<body>
    ...
    <div class="nav-item">
    <a href="{{ route('participant.reservations.historique') }}"> <i class="fas fa-history"></i>Mes Réservations</a></div>
    <div class="nav-item">
    <a href="{{ route('participant.notifications.index') }}"><i class="fas fa-bell"></i>Notifications</a></div>
    <div class="nav-item">
    <a href="{{ route('participant.favoris.index') }}"><i class="fas fa-star"></i>
        Mes Favoris
